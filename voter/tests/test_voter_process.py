...
from voter.management.commands.voter_process import process_file, get_file_lines, diff_dicts
...
class VoterProcessChangeTrackerTest(TestCase):
    ...
    def test_change_tracker_tallies(self):
        change_tallies = process_file(output=False, create_changes_only=True)
    ...
    def test_change_tracker_modified_values(self):
        process_file(output=False, create_changes_only=True, county_num=None)
...
class VoterProcessIntegrationTest(TestCase):
    ...
    def test_process_changes_integration(self):
        process_file(output=False, create_changes_only=False, county_num=None)
